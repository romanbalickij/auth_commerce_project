                        ...
                        <ul>
                            @foreach($products as $product)
                                <li style="margin-bottom: 10px">
                                    ...
                                    <div><strong>Product Price: </strong> {{presentPrice($product->price)}}</div>
                                    <div><strong>Product Quantity:</strong>{{$product->pivot->quantity}}</div>
                                    <div><strong>Product Attributes:</strong>
                                        <ul>
                                            <li>
